...
class NodeTest < ActiveSupport::TestCase
    ...
    describe "Node Behaviors" do 
        ...
        it "should add and return a node item" do 
            item = ActiveRepository::Aggregate::Nodes.new.register(:article, 'Blog::Post', false, :blog_repository )
        ...
        it "should find a registred node" do 
            ...
            nodes.register(:article, 'Blog::Post', false, :blog_repository )
        ...
        it "should return list of all registred node" do 
            nodes = ActiveRepository::Aggregate::Nodes.new
            nodes.register(:article, 'Blog::Post', false, :blog_repository )
            nodes.register(:user, 'Blog::User', false, :blog_repository     )
